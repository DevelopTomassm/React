...
export function CharactersRickAndMorty() {
        ...
        {personajes.map((item) => {
          return (
            <>
              <Fade top>
                <div
                  class="max-w-sm pb-5 mx-auto mt-4 overflow-hidden rounded-lg shadow-lg"
                  key={item.id}
                >
                  <div class="h-40 bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-600">
                    <div class="flex justify-center">
                      {" "}
                      <span class="mt-10 text-4xl font-extrabold text-white px-6">
                        Tony Stark
                      </span>
